...
describe 'RARITY' do
  ...
  context 'random sample' do
    oughta_be_rare 'needlesest'
    oughta_be_rare 'needlessest'
    oughta_be_common 'exit'
    oughta_be_common 'exits'
    oughta_be_common 'exited'
    oughta_be_common 'exiting'
    oughta_be_common 'alpine'
    oughta_be_rare 'alpined'
    oughta_be_rare 'alpines'
    oughta_be_rare 'alpiner'
    oughta_be_rare 'alpinest'
    oughta_be_rare 'alpining'
    oughta_be_common 'success'
    oughta_be_common 'successor'
    oughta_be_common 'successors'
    oughta_be_common 'succeed'
    oughta_be_rare 'succeedd'
    oughta_be_common 'succeeds'
    oughta_be_common 'succeeded'
    oughta_be_common 'succeeding'
    oughta_be_rare 'succeedor'
    oughta_be_rare 'succeedors'
    oughta_be_common 'posse'
    oughta_be_common 'posses'
    oughta_be_common 'possess'
    oughta_be_common 'possessor'
    oughta_be_rare 'possesser' # spelling variant
    oughta_be_rare 'poseser'
    oughta_be_rare 'posesor'
    oughta_be_common 'whip'
    oughta_be_common 'whips'
    oughta_be_rare 'whipe'
    oughta_be_rare 'whiping'
    oughta_be_rare 'whiped'
    oughta_be_rare 'whipes'
    oughta_be_common 'whipped'
    oughta_be_common 'whipping'
    oughta_be_rare 'whippeding'
    oughta_be_rare 'whippedings'
    oughta_be_common 'adore'
    oughta_be_common 'adoration'
    oughta_be_common 'observe'
    oughta_be_common 'observable'
    oughta_be_common 'observables'
    oughta_be_rare 'observeable'
    oughta_be_rare 'observeables'
    oughta_be_common 'malign'
    oughta_be_common 'maligns'
    oughta_be_common 'maligned'
    ...
    oughta_be_common 'present'
    oughta_be_common 'presents'
    oughta_be_rare 'presentss'
    oughta_be_common 'presented'
    oughta_be_common 'presenting'
    oughta_be_rare 'presenteds'
    oughta_be_rare 'presentd'
    oughta_be_rare 'presentsed'
    oughta_be_rare 'presentsing'
    ...
    oughta_be_rare 'klaas'
    oughta_be_rare 'ecu'
    oughta_be_rare 'brux'
    oughta_be_rare 'disbased'
    oughta_be_common 'reconcile'
    oughta_be_common 'reconciled'
    oughta_be_common 'reconciles'
    oughta_be_common 'reconciling'
    oughta_be_rare 'reconcils'
    oughta_be_rare 'reconcilest'
    oughta_be_rare 'reconcileing'
    oughta_be_rare 'reconcileding'
    oughta_be_rare 'reconciledest'
    oughta_be_rare 'reconcilesest'
    oughta_be_rare 'unreconcile'
    oughta_be_rare 'unreconciled'
    oughta_be_rare 'unreconciles'
    oughta_be_common 'pagan'
    oughta_be_rare 'paganic'
    oughta_be_rare 'millan'
    oughta_be_common 'bore'
    oughta_be_common 'bores'
    oughta_be_rare 'borest'
    oughta_be_common 'boring'
    oughta_be_rare 'boreing'
    oughta_be_common 'bored'
    oughta_be_rare 'boreding'
    oughta_be_common 'largesse'
    oughta_be_rare 'largessed'
    oughta_be_common 'gas'
    oughta_be_common 'gases'
    oughta_be_common 'gasses'
    oughta_be_common 'gassed'
    oughta_be_common 'gassing'
    oughta_be_common 'gasser'
    oughta_be_rare 'gass'
    oughta_be_rare 'gassers'
    oughta_be_rare 'gasserst'
    oughta_be_rare 'gaser'
    oughta_be_rare 'gasers'
    oughta_be_rare 'gased'
    oughta_be_rare 'gaseding'
    oughta_be_rare 'gasseding'
    oughta_be_rare 'gassedest'
    oughta_be_rare 'gasest'
    oughta_be_rare 'gassest'
  end
end
