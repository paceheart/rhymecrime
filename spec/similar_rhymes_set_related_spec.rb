#
# set_related — describes "for cue X, what rhyming groups (tuples) of related
# words should appear?". Largest of the three +similar_rhymes_*+ describe blocks
# (~210 examples, ~170s pre-LocalStore-warmup); split into its own file from
# +similar_rhymes_spec.rb+ so +parallel_rspec+ can run it alongside the smaller
# PAIR_RELATED / RELATED_RHYMES files instead of as one serialized chunk.
#
