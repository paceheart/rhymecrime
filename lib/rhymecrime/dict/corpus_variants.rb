...
# hand-edited +spec/spelling.csv+. All corpus I/O stays here: the runtime +preferred_form+
...
SPELLING_VARIANTS_AUTO_HEADER = <<~HEADER
  ...
  # load_variants_raw in utils_rhyme.rb (alongside the hand-edited spec/spelling.csv).
HEADER
...
# automatically without hand-editing +spec/spelling.csv+. Returns an array of
