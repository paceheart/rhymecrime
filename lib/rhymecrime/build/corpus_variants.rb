...
# (as opposed to the hand-curated US/UK dialectal rules in morphology/spelling.rb). Output goes to
...
SPELLING_VARIANTS_AUTO_HEADER = <<~HEADER
  ...
  # load_variants_raw in morphology/spelling.rb (alongside the hand-edited curated/spelling.csv).
HEADER
